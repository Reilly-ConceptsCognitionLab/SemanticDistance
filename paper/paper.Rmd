...
# Research impact statement
 `SemanticDistance` has supported one peer-reviewed publication to date in the journal, `Cortex` [@Mechtenberg:2026] along with one refereed conference presentation at the annual conference of the Society for the Neurobiology of Language. Importantly, the application enables a variety of analyses that have been formerly difficult or impossible, including comparing semantic distance measures with other predictive language indices (e.g., surprisal), including those generated by large language models. \newline
