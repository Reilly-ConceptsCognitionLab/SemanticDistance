...
This could be a story or instructions - anything where you don't care about talker information. You should format your transcript so that there is a vector (column) of words. All other metadata will be retained. <br/>
...
1) df = dataframe <br/>
2) wordcol = column name (quoted) containing the text you want cleaned <br/>
3) whotalks = column name (quoted) containing the talker ID (will convert to factor) <br/>
4) omit_stops = option for omitting stopwords, default is TRUE <br/>
5) lemmatize = option for lemmatizing strings, default is TRUE <br/>
```{r}
